...
class FilterRatingSteps {
	/**
	 * The step definitions below match with Katalon sample Gherkin steps
	 */
	@Given("User on the click Book Category")
	def clickBookCategory() {
		WebUI.click(findTestObject('Object_Filter_by_Rating/book_category'))
	}
	...
	def verifyFilterRating() {
		WebUI.verifyElementPresent(findTestObject('Object_Filter_by_Rating/verify_4stars'), 1)
