...
WebUI.setText(findTestObject('Login/username'), 'hhh')

WebUI.setText(findTestObject('Login/Password'), 'Hahahi_123')

WebUI.click(findTestObject('Login/btn-login'))

WebUI.verifyElementPresent(findTestObject('Login/Verify_login'), 0)
