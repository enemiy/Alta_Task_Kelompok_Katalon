...
WebUI.setText(findTestObject('ContactUs/Field_Username'), 'ihsan')

WebUI.setText(findTestObject('ContactUs/Field_Email'), 'ihsan@gmail.com')

WebUI.setText(findTestObject('ContactUs/Field_Enquiry'), 'test contact us')
